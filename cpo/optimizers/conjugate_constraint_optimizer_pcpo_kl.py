...
'''
This is PCPO with KL divergence projection, and this file is put in "rllab-master/sandbox/cpo/optimizers/"
'''
...
class ConjugateConstraintOptimizerPCPO_KL(Serializable):
    """
    ...
    def update_opt(self, loss, target, quad_leq_constraint, lin_leq_constraint, inputs, 
        ...
        ### For constraint 2
        #self._hvp_approach.update_opt(f=constraint_term_2, target=target, 
        #                              inputs=inputs + extra_inputs,
        #                              reg_coeff=self._reg_coeff)
